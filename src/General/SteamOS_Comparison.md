...
-   **Dual-boot** support with **Windows**.
...
-   **Fearless Updates**
  ...
  -   A **backlog of the previous 90 days of updates** is available, and you can easily roll back to any version with a simple command.
...
-   Up-to-date versions of **KDE Plasma** or **GNOME** depending on the image.
-   Useful **gaming-related software**, such as **Lutris, ScopeBuddy GUI, ProtonUp-QT/ProtonPlus, Protontricks**, and more.
-   Access to the **GNOME** desktop environment as an alternative to KDE Plasma.
-   Support for **virtualization** and **GPU passthrough** through Flatpaks.
-   **Android applications** can be installed with [Waydroid](/Installing_and_Managing_Software/Waydroid_Setup_Guide.md).
-   Simplified installation of [**Sunshine**](/Advanced/sunshine/) through the Bazzite Portal, allowing you to easily stream your games.
...
Secure Boot support is also useful for dual-booting with Windows, since it is required for certain anti-cheat software. 
>Read more in the [**Secure Boot Guide**](/General/Installation_Guide/secure_boot.md).
